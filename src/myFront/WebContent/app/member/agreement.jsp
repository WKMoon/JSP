		...
		<!-- Main -->
			<section id="main" class="wrapper style1">
				<div class="inner">
					...
					<!-- Content -->
						<div class="content">
	<textarea name="term" id="term" rows="15" style="resize:none;  height:100%;" readonly>시행일자 : 2020년 11월 16일

제1조 (목적)
본 약관은 문우경 주식회사(이하 '회사')가 고도 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.
