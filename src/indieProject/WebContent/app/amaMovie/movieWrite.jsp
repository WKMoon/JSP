				...
				<section id="step1">
					...
					<div class="row">
						<div class="col-2 col-3-small poster" style="padding-left: 0;">
							<span class="image fit" style="padding-bottom: 30%;"> <img
								class="camera"
					...
					<h3>스틸컷</h3>
					<div class="row">
						<div class="col-2 col-3-small stillcut" style="padding-left: 0;">
							<span class="image fit" style="padding-bottom: 30%;"> <img
								class="camera2"
								src="${pageContext.request.contextPath}/images/camera.png"
								alt="영화 스틸컷"
...
<!-- 					<hr class="mobileHr" style="margin: 0.5em 0 0.5em 0;"> -->
				...
				<section id="step3" style="display: none;">
					<div class="row">
						...
						<div class="col-5 col-7-medium col-12-small" style="margin-right: auto;">
							<textarea name="" id="" rows="3" cols="" style="resize: none;"></textarea>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-2 col-12-small"
							style="text-align: right; margin-right: auto; padding:0 0;">
								<a style="width:100%;" href="#" class="button small moveBtn">완료</a>
						</div>
					</div>
				</section>
